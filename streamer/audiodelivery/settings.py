...
AUDIO_MAX_DURATION = getattr(settings, "AUDIODELIVERY_MAX_DURATION", 5*60*1000) # 5 minutes

AUDIO_MAX_SIZE = getattr(settings, "AUDIODELIVERY_MAX_SIZE", 10*1024*1024) # 10 MB
